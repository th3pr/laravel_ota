<div>
                                ...
                                <form wire:submit.prevent="rate()">
                                    <div class="block max-w-3xl px-1 py-2 mx-auto">
                                        ...
                                        <div class="my-5">
                                            ...
                                            @enderror
                                            <textarea wire:model.lazy="comment" name="description" class="form-control" id="exampleFormControlTextarea1" placeholder="Comment.."></textarea>
                                        </div>
                                    </div>
                                    <div class="block">
                        ...
                        @else
                            <div>
                                <div class="mb-8 text-center text-gray-600">
                                    You need to login in order to be able to rate the hotel!
                                </div>
                                <a href="/register"
    ...
    <section class="relative block pt-20 pb-24 overflow-hidden text-left bg-white">
        <div class="w-full px-20 mx-auto text-left md:px-10 max-w-7xl xl:px-16">
            ...
            <div class="box-border flex grid flex-wrap justify-center-mx-4 text-center text-indigo-900 lg:gap-16 lg:justify-start lg:text-left">
                @forelse ($comments as $comment)
                    <div class="flex col-span-1 help-contact bg-grey-2 mt-2">
                        <div class="relative flex-shrink-0 w-20 h-20 text-left">
                            <a href="{{ '@' . $comment->user->username }}">
                                {{  $comment->user->name }}
                            </a>
                            <img src="{{asset('img/imges/1.jpg')}}" alt="..." class="img-thumbnail">
                        </div>
                        <div class="relative px-4 mb-16 leading-6 text-left ml-3">
